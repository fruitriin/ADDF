...
## 現在のフェーズ: 0035 フェーズA・B（PR 作法ドキュメント・投機運用拡張）完了・0033 完了（2026-07-05）。次は 0035 C→0036→0038→0037 の順で実装。0026 はオーナー指示待ち。未着手 0030〜0032、0029 フェーズ2以降
...
| 3 | 35 | `docs/plans-add/0035-pr-standard-format.md` | 一部完了（フェーズA・B 完了。C=誤完了 lint のみ残り） |
