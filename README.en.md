...
- **ccchain Command Gate (opt-in)** — Enable `[ccchain]` in `Behavior.toml` to wire an allowlist-based PreToolUse hook ([ccchain](https://github.com/fruitriin/EnumaElish)) that evaluates Bash commands and asks on destructive operations
