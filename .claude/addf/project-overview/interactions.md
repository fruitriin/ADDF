...
│  │ (Phase 2.5)     │  sync-       │ gui-test        │              │
│  │ release/overview│  optional-   │ addfTools(Swift)│              │
│  │ lock(ref形式)   │  skills.py   │ ui-test-agent   │              │
│  │ paths.toml 移行  │              │ checksums 検証  │              │
│  │ 部分導入正規化    │              └─────────────────┘              │
│  └───────▲────────┘                                               │
