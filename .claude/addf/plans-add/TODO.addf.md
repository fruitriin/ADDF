...
| 3 | 56 | `.claude/addf/plans-add/0056-plan-genealogy-tree.md` | 進行中（2026-07-17 標準テンプレート昇格・着手。edge 行書式確定〔行頭 key:value・pruned のみメタデータ必須・blocked-by owner/external 区分〕。フェーズ1=基盤+系統樹ページ / フェーズ2=全件遡及） |
